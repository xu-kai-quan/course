...
@ExtendWith(SpringExtension.class)//告诉junit5说我现在要进行spring相关的测试了
...
public class AuthIntegrationTest {
    ...
    private HttpResponse<String> post(String path, //path 是/user /session 这样的路径
                                      String accept,
                                      String contentType,
    ...
    public void getErrorIfUsernameAlreadyRegistered() {
        //注册用户
        //成功
        //再次使用同名用户注册
        //失败
